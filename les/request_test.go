...
type accessTestFn func(db probedb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db probedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db probedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db probedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db probedb.Database, bhash common.Hash, num uint64) light.OdrRequest {
