...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Probeum presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gprobe wallet import /path/to/my/presale.wallet

will prompt for your password and imports your probeer presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Probeum presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gprobe wallet [options] /path/to/my/presale.wallet
...
between probeum nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gprobe account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gprobe account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another probeum instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gprobeConfig{Node: defaultNodeConfig()}
	// Load config file.
