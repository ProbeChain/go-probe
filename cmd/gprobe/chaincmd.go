...
func initGenesis(ctx *cli.Context) error {
	...
	for _, name := range []string{"chaindata"} {
		...
		_, hash, err := core.SetupGenesisBlock(chaindb, genesis, stack.InstanceDir())
		if err != nil {
...
func parseDumpConfig(ctx *cli.Context, stack *node.Node) (*state.DumpConfig, probedb.Database, common.Hash, error) {
	db := utils.MakeChainDatabase(ctx, stack, true)
