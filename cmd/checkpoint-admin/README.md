...
There are several hardcoded checkpoints in the [source code](https://github.com/probeum/go-probeum/blob/master/params/config.go#L38) of the go-probeum project. These checkpoints are updated by go-probeum developers when new versions of software are released. Because light client users trust Gprobe developers to some extent, hardcoded checkpoints in the code can also be considered correct.
...
```shell
go get github.com/probeum/go-probeum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/probeum/go-probeum/blob/master/params/config.go#L251).*
