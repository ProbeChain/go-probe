...
var faucetKey, _ = probe.HexToECDSA("b71c71a67e1177ad4e901695e1b4b9ee17ae16c6668d313eac2f96dbcda3f291")

func (s *Suite) sendSuccessfulTxs(t *utesting.T, isProbe66 bool) error {
	...
	for i, tx := range tests {
		...
		if err := sendSuccessfulTx(s, tx, prevTx, isProbe66); err != nil {
...
func sendSuccessfulTx(s *Suite, tx *types.Transaction, prevTx *types.Transaction, isProbe66 bool) error {
...
func (s *Suite) sendMaliciousTxs(t *utesting.T, isProbe66 bool) error {
	...
	for i, tx := range badTxs {
		...
		if err = sendMaliciousTx(s, tx, isProbe66); err != nil {
...
func sendMaliciousTx(s *Suite, tx *types.Transaction, isProbe66 bool) error {
	// setup connection
	var (
		conn *Conn
		err  error
...
// checkMaliciousTxPropagation checks whprobeer the given malicious transactions were
