...
.PHONY: gprobe probec android ios gprobe-cross evm all test clean
...
probec:
	env GO111MODULE=on go build -o $(GOBIN)/probec ./probe-lang/cmd/probec
	@echo "Done building."
	@echo "Run \"$(GOBIN)/probec\" to launch the PROBE language compiler."
