...
// Package forkid implements EIP-2124 (https://eips.probeum.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the ProbeChain fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the ProbeChain fork ID from an existing chain instance.
...
func newFilter(config *params.ChainConfig, genesis common.Hash, headfn func() uint64) Filter {
	...
	return func(id ID) error {
		...
		return nil // Somprobeing's very wrong, accept rather than reject
	}
}
