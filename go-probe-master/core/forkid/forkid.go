...
// NewID calculates the Probeum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Probeum fork ID from an existing chain instance.
