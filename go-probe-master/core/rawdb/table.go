...
func NewTable(db probedb.Database, prefix string) probedb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) probedb.Iterator {
...
func (t *table) NewBatch() probedb.Batch {
...
func (b *tableBatch) Replay(w probedb.KeyValueWriter) error {
...
type tableIterator struct {
	iter   probedb.Iterator
	prefix string
}

// Next moves the iterator to the next key/value pair. It returns whprobeer the
