...
func TestNodeIterator(t *testing.T) {
	...
	blockchain, _ := core.NewBlockChain(fulldb, nil, params.TestChainConfig, pob.NewFullFaker(), vm.Config{}, nil, nil, nil)
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, pob.NewFaker(), fulldb, 4, testChainGen)
