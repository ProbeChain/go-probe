 ...
 * @author Gary Rong<garyrong@probeum.org>, Martin Swende <martin.swende@probeum.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the probeum.
    uint sectionSize;
