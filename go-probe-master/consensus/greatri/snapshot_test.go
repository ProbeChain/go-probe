...
// mapped from textual names used in the tests below to actual Probeum private
...
// checkpoint creates a Greatri checkpoint signer section from the provided list
...
// address retrieves the Probeum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Probeum address
	return crypto.PubkeyToAddress(ap.accounts[account].PublicKey)
}

// sign calculates a Greatri digital signature for the given block and embeds it
...
// the account may or may not have cast a Greatri vote.
...
// Tests that Greatri signer voting is evaluated correctly for various simple and
// complex scenarios, as well as that a few special corner cases fail correctly.
func TestGreatri(t *testing.T) {
	...
	for i, tt := range tests {
		...
		// Pass all the headers through greatri and ensure tallying succeeds
