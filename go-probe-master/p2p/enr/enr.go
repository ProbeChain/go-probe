...
// Package enr implements Probeum Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whprobeer the record is signed using the given identity scheme.
