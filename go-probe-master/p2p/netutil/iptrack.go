...
// PredictFullConeNAT checks whprobeer the local host is behind full cone NAT. It predicts by
// checking whprobeer any statement has been received from a node we didn't contact before
