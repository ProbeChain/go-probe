...
// most of Probeum's existence, so might as well go with it.
...
// An Probeum node doesn't need hundreds of connections to operate correctly,
...
type Tracker struct {
	...
	// (eg. probe.getHeaders vs snap.getAccountRange).
