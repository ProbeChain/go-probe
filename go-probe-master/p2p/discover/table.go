...
// isInitDone returns whprobeer the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whprobeer the caller wants liveness-checked results. If
