...
# 1. install gprobe for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gprobe
# 5. create gprobe, attach and uninstall start menu entries
...
!define GROUPNAME "Probeum"
!define APPNAME "Gprobe"
!define DESCRIPTION "Official Go implementation of the Probeum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gprobe is installed global
