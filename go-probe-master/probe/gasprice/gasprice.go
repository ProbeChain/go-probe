...
var (
	DefaultMaxPrice    = big.NewInt(500 * params.GPico)
	DefaultIgnorePrice = big.NewInt(2 * params.Pico)
)
...
//
// Note, for legacy transactions and the legacy probe_gasPrice RPC call, it will be
