...
// TestProbe66EmptyMessages tests encoding of empty probe66 messages
func TestProbe66EmptyMessages(t *testing.T) {
...
// TestProbe66Messages tests the encoding of all redefined probe66 messages
func TestProbe66Messages(t *testing.T) {
	t.Skip("skipped: block RLP encoding changed with PoB BehaviorProofUncles/Acks fields")
