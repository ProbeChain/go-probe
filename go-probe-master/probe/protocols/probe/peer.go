...
// Peer is a collection of relevant information we have about a `probe` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `probe` protocol version.
...
// KnownBlock returns whprobeer peer is known to already have a block.
func (p *Peer) KnownBlock(hash common.Hash) bool {
	return p.knownBlocks.Contains(hash)
}

// KnownTransaction returns whprobeer peer is known to already have a transaction.
...
// ReplyPooledTransactionsRLP is the probe/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the probe/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the probe/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the probe/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the probe/66 response to GetReceipts.
