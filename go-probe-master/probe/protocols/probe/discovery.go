...
// StartENRUpdater starts the `probe` ENR updater loop, which listens for chain
...
// currentENREntry constructs an `probe` ENR entry based on the current state of the chain.
