...
// Syncing provides information when this nodes starts synchronising with the ProbeChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  probeum.SyncProgress `json:"status"`
}
