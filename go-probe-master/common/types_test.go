...
func TestDpos(t *testing.T) {
	...
	lastRoundId := CalcValidatorRoundId(lastConfirmNumber, epoch)
	...
	confirmRoundId := CalcValidatorRoundId(confirmNumber, epoch)
	//confirmRoundId2 := CalcValidatorRoundId(number, epoch)
