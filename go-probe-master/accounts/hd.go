...
// the `coin_type` 60' (or 0x8000003C) to Probeum.
//
// The root path for Probeum is m/44'/60'/0'/0 according to the specification
// from https://github.com/probeum/EIPs/issues/84, albeit it's not set in stone
// yet whprobeer accounts should increment the last component or the children of
