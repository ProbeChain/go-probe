// Copyright 2014 The go-probe Authors
...
func (l *loggingDb) NewBatch() probedb.Batch {
	return l.backend.NewBatch()
}

func (l *loggingDb) NewIterator(prefix []byte, start []byte) probedb.Iterator {
