...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gprobe.ipc", false, filepath.Join(os.TempDir(), "gprobe.ipc")},
		{"data", "gprobe.ipc", false, "data/gprobe.ipc"},
		{"data", "./gprobe.ipc", false, "./gprobe.ipc"},
		{"data", "/gprobe.ipc", false, "/gprobe.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gprobe.ipc", true, `\\.\pipe\gprobe.ipc`},
		{"data", "gprobe.ipc", true, `\\.\pipe\gprobe.ipc`},
		{"data", `\\.\pipe\gprobe.ipc`, true, `\\.\pipe\gprobe.ipc`},
	}
