...
func (c Config) MarshalTOML() (interface{}, error) {
	...
	enc.ProbeDiscoveryURLs = c.ProbeDiscoveryURLs
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.ProbeDiscoveryURLs != nil {
		c.ProbeDiscoveryURLs = dec.ProbeDiscoveryURLs
	}
