...
func TestDpospool(t *testing.T) {
	candidateDPOSAccounts := []DPoSCandidateAccount{
		...
		{[]byte("enode://000000000000000000000000@192.168.0.4:80"), [25]byte{0}, big.NewInt(3), big.NewInt(200)},
		{[]byte("enode://000000000000000000000000@192.168.1.3:80"), [25]byte{0}, big.NewInt(3), big.NewInt(400)},
		{[]byte("enode://000000000000000000000000@192.168.1.4:80"), [25]byte{0}, big.NewInt(3), big.NewInt(500)},
	}
